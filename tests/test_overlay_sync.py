...
Focused on the display_status derivation that drives capture-point
...
from src.ui.overlay_sync import display_status
...
class TestDisplayStatus:
    ...
    def test_partial_when_some_good_frames(self) -> None:
        ...
        assert display_status(cp) == "partial"
    ...
    def test_complete_when_target_reached(self) -> None:
        ...
        assert display_status(cp) == "complete"
    ...
    def test_skipped_takes_precedence_over_frames(self) -> None:
        ...
        assert display_status(cp) == "skipped"
