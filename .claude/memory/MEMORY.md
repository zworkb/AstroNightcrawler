...
- [feedback_remote_visual_companion.md](feedback_remote_visual_companion.md) — User works remotely; visual companion must bind to 0.0.0.0 with LAN IP
- [project_tech_stack.md](project_tech_stack.md) — NiceGUI as web framework; all UI decisions should align with its capabilities
